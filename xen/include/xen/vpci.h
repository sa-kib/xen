...
int msix_read(struct domain *d, struct vpci_msix *msix,
              unsigned long addr, unsigned int len, unsigned long *data);

u8 vpci_arch_readb(unsigned long addr);
u16 vpci_arch_readw(unsigned long addr);
u32 vpci_arch_readl(unsigned long addr);
u64 vpci_arch_readq(unsigned long addr);

void vpci_arch_writeb(u8 data, unsigned long addr);
void vpci_arch_writew(u16 data, unsigned long addr);
